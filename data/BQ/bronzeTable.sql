...
OPTIONS (
  format = 'JSON',
  uris = ['gs://retailer-raw-data-11111/landing/retailer-db/orders/*.json']
);
...
OPTIONS (
    format = 'JSON',
    uris = ['gs://retailer-raw-data-11111/landing/retailer-db/customers/*.json']
);
...
OPTIONS (
    format = 'JSON',
    uris = ['gs://retailer-raw-data-11111/landing/retailer-db/products/*.json']
);
...
OPTIONS (
    format = 'JSON',
    uris = ['gs://retailer-raw-data-11111/landing/retailer-db/categories/*.json']
);
...
OPTIONS (
    format = 'JSON',
    uris = ['gs://retailer-raw-data-11111/landing/retailer-db/order_items/*.json']
);
-------------------------------------------------------------------------------------------------------------
-- Suppliers Table
...
OPTIONS (
  format = 'JSON',
  uris = ['gs://retailer-raw-data-11111/landing/supplier-db/suppliers/*.json']
);
...
OPTIONS (
  format = 'JSON',
  uris = ['gs://retailer-raw-data-11111/landing/supplier-db/product_suppliers/*.json']
);
...
OPTIONS (
  format = 'PARQUET',
  uris = ['gs://retailer-raw-data-11111/landing/customer_reviews/customer_reviews_*.parquet']
);
