...
OPTIONS (
  format = 'JSON',
  uris = ['gs://retailer-raw-data-11111/bronze/retailer-db/orders/*.json']
);
...
OPTIONS (
    format = 'JSON',
    uris = ['gs://retailer-raw-data-11111/bronze/retailer-db/customers/*.json']
);
...
OPTIONS (
    format = 'JSON',
    uris = ['gs://retailer-raw-data-11111/bronze/retailer-db/products/*.json']
);
...
OPTIONS (
    format = 'JSON',
    uris = ['gs://retailer-raw-data-11111/bronze/retailer-db/categories/*.json']
);
...
OPTIONS (
    format = 'JSON',
    uris = ['gs://retailer-raw-data-11111/bronze/retailer-db/order_items/*.json']
);
-------------------------------------------------------------------------------------------------------------
-- Suppliers Table
...
OPTIONS (
  format = 'JSON',
  uris = ['gs://retailer-raw-data-11111/bronze/supplier-db/suppliers/*.json']
);
...
OPTIONS (
  format = 'JSON',
  uris = ['gs://retailer-raw-data-11111/bronze/supplier-db/product_suppliers/*.json']
);
...
OPTIONS (
  format = 'PARQUET',
  uris = ['gs://retailer-raw-data-11111/bronze/customer_reviews/customer_reviews_*.parquet']
);
